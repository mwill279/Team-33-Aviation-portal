...
## Installation:
```bash
pip install wheel libsass django-sass-processor django-google-maps django-mapbox-location-field django-crispy-forms social-auth-app-django psycopg2-binary pyresparser Pillow nltk
```
